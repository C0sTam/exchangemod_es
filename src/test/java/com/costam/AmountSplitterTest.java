...
/**
 * Testy dla rzeczywistego kodu - klasa AmountSplitter z ExchangeBota
 *
 * Te testy sprawdzają czy funkcja poprawnie dzieli duże ilości na mniejsze części
 * (max 100k na raz) - używane w handlowaniu grze
 */
public class AmountSplitterTest {
    ...
    @Test
    public void testSplitAmountAbove100k() {
        // Liczba powyżej 100k - powinno być 2 części
        ...
        assertEquals("Druga część: 1", 1L, (long) result.get(1));
    }
